package com.wigo.cmm.common.jwt;

import java.util.Date;
import java.util.HashMap;
import java.util.Map;

import com.wigo.cmm.common.model.EzApiException;
 ...
 *
 * <pre>
 * com.wigo.cmm.config - JwtUtility.java
 * </pre>
 *
...
public class JwtUtility {
	final static String JWT_KEY = "1qaz@WSX";
	...
	public static Map<String, Object> verifyJWT(String jwt) {
		...
		try {
			Claims claims = Jwts.parser().setSigningKey(JWT_KEY.getBytes("UTF-8")) // Set Key
