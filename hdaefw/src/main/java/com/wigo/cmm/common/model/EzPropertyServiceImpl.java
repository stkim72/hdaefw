 ...
 */
package com.wigo.cmm.common.model;
 ...
 *
 * <pre>
 * com.wigo.cmm.common.model - EzPropertyServiceImpl.java
 * </pre>
 *
...
public class EzPropertyServiceImpl
	...
	public void refreshPropertyFiles() throws Exception {
		...
		try {
			...
			throw new EzException(new String[] { fileName }.toString(), e);
			...
			if (properties != null) {
				...
				while (it.hasNext()) {
					...
					if (key == null || key.equals("")) {
						throw new EzException("error.properties.check.essential");
					}
