 ...
 * 
 * <pre>
 * com.wigo.cmm.common.util - RefreshableSqlSessionFactoryBean.java
 * </pre>
 *
 * @ClassName : RefreshableSqlSessionFactoryBean
 * @Description : SQL xml 파일 수정시 재로드 유틸
 * @author : 김성태
 * @date : 2021. 1. 5.
 * @Version : 1.0
...
public class RefreshableSqlSessionFactoryBean extends SqlSessionFactoryBean implements DisposableBean {
	 ...
	 * alternative to a
	 * 
	 * {@code &lt;properties&gt;} tag in the configuration xml file. This will be
	 * used to
	 * 
				...
				if (mapperLocations != null) {
					...
					if (xmlConfigBuilder != null) {
						try {
							...
							// Configuration 클래스의 protected member field 인
							// loadedResources 를 얻기 위해 reflection 을 사용함.
