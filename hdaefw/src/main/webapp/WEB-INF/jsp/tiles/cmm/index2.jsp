...
<head>
    ...
    <!-- ======================= css ===================== -->
<!--     <link rel="stylesheet" href="/static/cmm/css/style.css"> -->
    ...
    <header class="header">
        <div class="container">
            <div class="header_menu">
                <a href="#" class="full_menu" id="full-toggle"><img src="/static/cmm/images/menu.png" alt="fullmenu"></a>
                <h1><a href="/"><img src="/static/cmm/images/logo.png" alt=""></a></h1>
					...
					<li><a href="#" class="gnb_link">${topLevelMenu.menuNm }</a>
                        <ul class="sub">
							...
							<c:if test='${subMenu.menuShowYn eq "Y" }'>
								<a href="#" data-click="showToplevelMenu" class="sub_link" data-top-menu-cd="${subMenu.topMenuId }" data-menu-cd= "${subMenu.menuId }">${subMenu.menuNm }</a> 
							</c:if>
							</c:forEach>
							</li>
                        </ul>
            ...
            <div class="header_user">
                <img src="/static/cmm/images/user1.png" alt="">
        ...
        <ul class="header_side">
        	...
        	<c:forEach var="topLevelMenu" items="${ menuTree.children}">
				<c:if test='${topLevelMenu.menuShowYn eq "Y" }'>
					<c:forEach var="subMenu" items="${ topLevelMenu.children}">
						<c:if test='${subMenu.menuShowYn eq "Y" }'>
						<c:set var="subMenuData">data-top-menu-cd="${ subMenu.topMenuId}" data-menu-cd="${subMenu.menuId }" data-menu-lvl-no="${subMenu.menuLvlNo }" data-menu-url="${subMenu.menuUrl }"</c:set>
						<li data-menu-depth="2" style="<c:if test='${cnt > 1 }'><c:set value="2" var="cnt" />display:none</c:if>" ${subMenuData }>
                			...
                			<ul data-menu-depth="3" class="sub_depth2" style="display:none" ${subMenuData }>
                				...
                				<c:set var="menu3Data">data-top-menu-cd="${ menu3.topMenuId}" data-menu-cd="${menu3.menuId }" data-menu-lvl-no="${menu3.menuLvlNo }" data-menu-url="${menu3.menuUrl }"</c:set>
                			 ...
                			 <li ${menu3Data }>
                			 	...
                			 	<c:if test="${!empty menu3.children}">
                			 		...
                			 		<c:forEach var="menu4" items="${ menu3.children}">
                			 			...
                			 			<c:set var="menu4Data">data-top-menu-cd="${ menu4.topMenuId}" data-menu-cd="${menu4.menuId }" data-menu-lvl-no="${menu4.menuLvlNo }" data-menu-url="${menu4.menuUrl }"</c:set>
                			 			<li ${menu4Data }>
...
<!--             콘텐츠 -->
        ...
        <div class="wedget">
            <a href="#">
                <img src="/static/cmm/images/widget1.png" alt="">
                <span>위젯1</span>
            </a>
            <a href="#">
                <img src="/static/cmm/images/widget2.png" alt="">
                <span>위젯2</span>
            </a>
            <a href="#">
                <img src="/static/cmm/images/widget3.png" alt="">
                <span>위젯3</span>
            </a>
        </div>
...
//     	}
    ...
    function showSecondMenu(menuId){
    	var $li = $("li[data-menu-depth=2][data-menu-cd="+menuId+"]");
    	$("ul[data-menu-depth=3]").hide();
    	$("ul[data-menu-depth=3][data-menu-cd="+menuId+"]").show();
    	
    	$(".side_depth1").removeClass("active");
    	$(".side_depth1[data-menu-cd="+menuId+"]").addClass("active");
