...
<form role="form" id="frmSearch">
		...
		<ul>
			...
			<li class="wAuto">
				...
				<div class="txt">
					<div class="mFlex2">
						<span class="flex">
                            <code:commCode name="useDivCd" id="useDivCd" codeCd="CH010" prefixLabel="전체" prefixValue=""/>
                        </span>
					</div>
				</div>
			</li>
    ...
    data-tpl-url="<c:url value='/static/gridTemplate/cst/CR048.xml'/>">
</div>
...
function search()
{
    var url = "<c:url value='${urlPrefix}/getLoginList${urlSuffix}'/>";
