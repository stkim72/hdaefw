...
<!-- 					  <a href="#;" data-click="saveNoticeDetail" id="btnSaveNoticeDetail" class="mBtn1 m lWhite" style="cursor: pointer;">저장</a> -->
	...
	<div class="gRight " style="margin-left:${wOffset2}">
		...
		<div class="mBox1 p24 btnTopMargin">
			<div class="gTitle1">
								...
								<table>
									...
									<tbody>
										...
										<tr>
                                            ...
                                            <th scope="row" class="left">최상위노출</th>
                                            <td>
                                                  <code:commCode codeCd="S050" name="noteYn" id="noteYn" others=" disabled "/>
<!--                                                 <input type="text" name="noteYn" id="noteYn" readonly="readonly" class="it"/> -->
                                            </td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td colspan= "7">
												<div id="attFiles" data-type="attachFiles" data-mode="edit" class="left" style="min-height:110px"></div>
											</td>
										</tr>
									</tbody>
								</table>
