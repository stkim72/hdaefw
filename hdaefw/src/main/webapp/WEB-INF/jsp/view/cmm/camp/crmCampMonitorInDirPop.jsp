	        ...
	        <ul>
	            <li class="wAuto">
	                <div class="tit w100">시작일</div>
                  		<div class="txt">
                    	<div class="mDate1">
                    		<input class="it" type="text" data-type="dateRangeStart" data-range-end="searchCampEndYmd" id="searchPromStaYmd" name="searchCampStaYmd" data-enter="search" data-button="Y"/>
                    		<span class="bar">~</span>
