          ...
          <div class="mBox1">
			<div class="gTitle1 ">
								...
								<div class="gRt">
									<div class="mFlex2">
                                           <span class="flex">
                                               <input type="text" id="sWord" data-type="searchTree" data-tree="divTree"  name="sWord" class="it" class="it" title="메뉴명" value="">
                                           </span>
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<th scope="row" class="left" style="">메뉴설명</th>
											<td style="">
												<input type="text" name="menuExpln" id="menuExpln"  class="it" />
											</td>
                                            <th scope="row" class="left" style="display:none">팝업여부</th>
                                            <td style="display:none">
                                                <code:commCode name="menuPopupYn" id="menuPopupYn" codeCd="S050"/>
                                            </td>
