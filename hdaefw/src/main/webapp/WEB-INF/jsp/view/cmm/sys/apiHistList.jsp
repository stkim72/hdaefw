...
<!--                      </div> -->
                     ...
                     <div class="tit" style="width: 4%;">응답채널</div>
                     <div class="txt" style="width:6%">
                     	<code:commCode id="sysCd" name="sysCd" codeCd="S000" prefixLabel="전체" prefixValue=""/>
                     </div>
                     <div class="tit" style="width: 4%;">호출채널</div>
                     <div class="txt" style="width:6%">
                        <code:commCode id="apiCallSysCd" name="apiCallSysCd" codeCd="S000" prefixLabel="전체" prefixValue=""/>
                     </div>
