									...
									<tbody>
										<tr>
											...
											<td scope="row" class="left">
												<input class="it" type="text" id="loginIdLike" data-enter="search" name="loginIdLike" placeholder="변경자ID">
											</td>
											...
											<td scope="row" class="left">
												<input class="it" type="text" id="userNmLike" data-enter="search" name="userNmLike"  placeholder="변경자명">
											</td>
											<th class="left">
												메뉴
											</th>
