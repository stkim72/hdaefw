		...
		<ul>
			...
			<li class="wAuto">
				...
				<div class="txt">
					<div class="mFlex2">
						<span class="flex">
                        	<code:commCode name="sendType" id="sendType" codeCd="SD010" prefixLabel="전체" prefixValue=""/>
                        </span>
			...
			<li class="wAuto">
				...
				<div class="txt">
					<div class="mFlex2">
						<span class="flex">
                        	<code:commCode name="sendResult" id="sendResult" codeCd="S050" prefixLabel="전체" prefixValue=""/>
                        </span>
					</div>
				</div>
			</li>
...
<div  id="divGrid" style="height:335px" data-grid-id="grdList" 
	...
	data-tpl-url="<c:url value='/static/gridTemplate/cst/CR045.xml'/>">
</div>
...
function search()
{
    var url = "<c:url value='${urlPrefix}/getSendList${urlSuffix}'/>";
