...
<!-- 												<input class="it" type="text" id="empId" data-enter="search" name="empId" placeholder="사용자ID"> -->
<!-- 											</td> -->
											<th>
												그룹
											</th>
 ...
 <div class="gTitle1 ">
								<h3 class="mTitle1">그룹별 메뉴변경 이력</h3>
								<div class="gRt">
									<code:btnGroup name="ApiHist" hideDelete="true" hideInsert="true" hideSave="true" dispName="그룹별_메뉴변경_이력" gridId="grdList"/>
								</div>
			</div>
 	<div id="divGrid"  style="height:${rightBoxHeight4}" data-grid-id="grdList" 
                                        ...
                                        data-tpl-url="<c:url value='/static/gridTemplate/system/cmmGrpMenuHst.xml'/>"
				>
