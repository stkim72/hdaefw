...
<!-- 											</td> -->
											...
											<td scope="row" class="left">
												<input class="it" type="text" id="orgNmLike" data-enter="search" name="orgNmLike" placeholder="부서명">
											</td>
 ...
 <div class="gTitle1 ">
								...
								<div class="gRt">
									<code:btnGroup name="GrpOrgHist" hideDelete="true" hideInsert="true" hideSave="true" dispName="그룹별_조직_변경_이력" gridId="grdList"/>
								</div>
			</div>
 	<div id="divGrid"  style="height:${rightBoxHeight4}" data-grid-id="grdList" 
                                        ...
                                        data-tpl-url="<c:url value='/static/gridTemplate/system/cmmGrpOrgHst.xml'/>"
				>
