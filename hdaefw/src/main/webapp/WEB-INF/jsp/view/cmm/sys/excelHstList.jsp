...
<div class="mBox1">
			...
			<form role="form" id="frmSearch">
								<table>
									...
									<tbody>
										<tr>
											<th scope="row" class="left">다운로드일</th>
											<td>
...
<!-- 											</td> -->
											...
											<td scope="row" class="left">
												<input class="it" type="text" id="menuNmLike" data-enter="search" name="menuNmLike" placeholder="메뉴명">
											</td>
											<th>
												엑셀명
											</th>
											<td scope="row" class="left">
												<input class="it" type="text" id="dnldNmLike" data-enter="search" name="dnldNmLike" placeholder="엑셀명">
											</td>
 ...
 <div class="gTitle1 ">
								<h3 class="mTitle1">엑셀다운로드이력</h3>
								<div class="gRt">
									<code:btnGroup name="ErrorHist" hideDelete="true" hideInsert="true" hideSave="true" dispName="엑셀다운로드이력" gridId="grdList"/>
								</div>
			</div>
 	<div id="divGrid"  style="height:${rightBoxHeight4}" data-grid-id="grdList" 
                                        ...
                                        data-tpl-url="<c:url value='/static/gridTemplate/system/cmmXlsDnldHst.xml'/>"
				>
