...
<!--                             </td> -->
                        ...
                        <tr>
                            ...
                            <td class="left" colspan="3">
                            <div id="attFiles" class="left" style="min-height:110px" data-type="attachFiles" data-file-cd="${vo.fileCd }"  data-mode="edit"></div>
                            </td>
                        </tr>
...
<script>
	function saveNotice(){
		...
		if(saveJson.postStaDt && saveJson.postEndDt && saveJson.postStaDt > saveJson.postEndDt){
            alert("게시시작일은 게시종료일보다 작아야 합니다.");
            $("#postStaDt")[0].focus();
            return;
