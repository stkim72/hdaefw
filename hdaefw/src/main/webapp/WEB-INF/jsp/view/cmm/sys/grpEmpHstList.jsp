...
<!-- 											</td> -->
											...
											<td scope="row" class="left">
												<input class="it" type="text" id="empNmLike" data-enter="search" name="empNmLike" placeholder="사용자명">
											</td>
 ...
 <div class="gTitle1 ">
								<h3 class="mTitle1">그룹별 사원 이력</h3>
								<div class="gRt">
									<code:btnGroup name="GrpEmpHist" hideDelete="true" hideInsert="true" hideSave="true" dispName="그룹별사원변경" gridId="grdList"/>
								</div>
			</div>
 	<div id="divGrid"  style="height:${rightBoxHeight4}" data-grid-id="grdList" 
                                        ...
                                        data-tpl-url="<c:url value='/static/gridTemplate/system/cmmGrpEmpHst.xml'/>"
				>
