...
<form role="form" id="frmSearch">
	<div class="mSort2 medium">
		<ul>
			...
			<li class="wAuto">
				<div class="tit">카드타입</div>
				<div class="txt">
					<div class="mFlex2">
						<span class="flex">
                        	<code:commCode name="cardTypeCd" id="cardTypeCd" codeCd="CD010" prefixLabel="전체" prefixValue=""/>
                     	</span>
					</div>
				</div>
			</li>
...
<div  id="divGrid" style="height:335px" data-grid-id="grdList" 
	...
	data-tpl-url="<c:url value='/static/gridTemplate/cst/CR044.xml'/>">
</div>
...
function search()
{
    var url = "<c:url value='${urlPrefix}/getCardList${urlSuffix}'/>";
