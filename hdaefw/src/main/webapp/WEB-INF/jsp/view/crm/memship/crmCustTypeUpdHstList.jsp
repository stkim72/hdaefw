...
<div id="wrapIframe" class="closed"> <!-- 고객정보 닫힘 -->
    ...
    <div class="cont">
        ...
        <div class="gTitle1 line">
            <h3 class="mTitle1">고객유형 일일 검색</h3>
        </div>
		...
		<form role="form" id="frmTypeDay" name="frmTypeDay">
				<ul>
					...
					<li class="w20per">
						<div class="tit">변경전유형</div>
						<div class="txt">
							<div class="mFlex2">
								<code:commCode  className="select w100" id="custTypeCd" name="custTypeCd" codeCd="CU030" prefixLabel="전체" prefixValue=""/>
					...
					<li class="w20per">
						<div class="tit">변경후유형</div>
						<div class="txt">
							<div class="mFlex2">
								<code:commCode  className="select w100" id="upCustTypeCd" name="upCustTypeCd" codeCd="CU030" prefixLabel="전체" prefixValue=""/>
					...
					<div class="" style="margin-left:50px">
						<button class="mBtn1" onclick="$('#frmTypeDay')[0].reset()" style="margin-right: 5px">초기화</button>
	...
	<div class="gTitle1">
			<h3 class="mTitle1">고객유형 일일 목록</h3>
			<div class="gRt">
	 ...
	 <div id="divCardHst" style="height:540px"
			  ...
			  data-pagenation="Y"
			  data-get-url="<c:url value='/cmmCustTypeUpdHst/getList'/>"
			  data-type="grid" 
                    	data-block-ui="Y"
			  data-tpl-url="<c:url value='/static/gridTemplate/memship/cmmCustTypeUpdHst.xml'/>">
...
function search() {
	...
	var valid = validateForm("#frmTypeDay"); //  class='data-check' 인 경우만 체크
	if(!valid) {
	...
	var param = Utilities.formToMap("frmTypeDay");
