...
<div class="mBox1">
			...
			<form role="form" id="frmSearch">
								<table>
									...
									<tbody>
										<tr>
											<th scope="row" class="left">에러발생일</th>
											<td>
...
<!-- 											</td> -->
											...
											<td scope="row" class="left">
												<input class="it" type="text" id="menuUrlLike" data-enter="search" name="menuUrlLike" placeholder="URL">
											</td>
											<th>
												메뉴명
											</th>
 ...
 <div class="gTitle1 ">
 	...
 	<div id="divGrid"  style="height:${rightBoxHeight4}" data-grid-id="grdList" 
                                        ...
                                        data-tpl-url="<c:url value='/static/gridTemplate/system/cmmErrHst.xml'/>"
				>
...
// 	showDetail(json);
Utilities.textDialog(json.errMsgTxn,"오류내역",true)
}
